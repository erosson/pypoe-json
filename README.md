...
* I can't run PyPoE from Linux

### How does this work?

Once a day, the buildbot checks to see if PoE's Steam content has been updated. If it has, we download it, run PyPoE, and send the developer a pull request. Once the kinks are worked out, we'll start auto-merging the pull requests.
...
It costs me nothing so I won't stop you, but you really should host them yourself. I'm not evil, but if I were, hotlinking gives me the power to break your program.
